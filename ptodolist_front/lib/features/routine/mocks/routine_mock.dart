...
final mockRoutines = [
  ...
  Routine(id: 'r-6', title: '이메일 확인', categoryId: 'cat-3', createdAt: DateTime(2026, 1, 1), order: 5),
  Routine(id: 'r-7', title: '스트레칭', categoryId: 'cat-1', createdAt: DateTime(2026, 1, 1), order: 6),
  Routine(id: 'r-8', title: '명상 10분', categoryId: 'cat-4', createdAt: DateTime(2026, 1, 1), order: 7),
];
